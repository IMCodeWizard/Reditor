Pod::Spec.new do |s|
    ...
    s.homepage = 'https://www.remoty.com'
    s.social_media_url = 'https://www.remoty.com'
    s.description  = <<-DESC
                        # Reditor
    ...
    s.author = { 'iOS Ninja' => 'igor@remoty.com' }
    ...
    s.swift_version = '4.0'
    s.requires_arc = true
    s.source = { :git => 'https://iosninja@dev.azure.com/remoty-visual/Remoty/_git/Reditor-iOS', :tag => s.version.to_s  }
